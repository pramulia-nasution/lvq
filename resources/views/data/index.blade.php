...
@section('content')
    <div class="col-md-12 padding-0">
        <div style="margin-bottom:20px;">
            <a href="#" onclick="Import()" class="btn btn-primary btn-3d"><i class="fa fa-download"></i> Import Dataset</a>
            <a href="#" onclick="Truncate()" class="btn btn-danger btn-3d"><i class="fa fa-trash"></i> kosongkan Dataset</a>
        </div>        
